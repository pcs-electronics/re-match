...
6. **Default Chart Type**: The default chart type is Smith chart, but you may offer other options to the user in a "for dummies" format. Never refer to Python files when offering options.
